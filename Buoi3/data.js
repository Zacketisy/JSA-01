...
for (let product of products) {
    ...
    //tạo thẻ img với src là giá trị của thuộc tính image các 
    //obj và thêm thẻ img thành con của div class image-cotainer, 
    //cuối cùng thêm thẻ div class image container thành con của div card
...
document.getElementById("search").addEventListener("click",
    function () {
        ...
        let productNames = document.getElementsByClassName
            ("product-name");
